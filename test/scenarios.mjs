...
const build = {
  '270': p => [isa('000000777'),
    'GS*HS*EXAMPLECLINIC*CLEARMOCK*20260830*1200*777*X*005010X279A1',
    'ST*270*0001*005010X279A1', 'BHT*0022*13*TM900*20260830*1200', 'HL*1**20*1',
    `NM1*PR*2*${p.payerName}*****PI*${p.payerId}`, 'HL*2*1*21*1',
    'NM1*1P*2*EXAMPLE BEHAVIORAL HEALTH*****XX*1093817465', 'HL*3*2*22*0', 'TRN*1*TM900*9990000001',
  ...
  '837': (p, sv = {}) => [isa('000000888'),
    'GS*HC*EXAMPLECLINIC*CLEARMOCK*20260830*1200*888*X*005010X222A1',
